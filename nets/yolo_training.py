...
class YOLOLoss(nn.Module):
    ...
    def forward(self, input, targets=None):
        ...
        # print(f'[INFO] loss_h: {loss_h}')
        # print(f'[INFO] conf: {conf[0]}')
        ...
        # print(f'[INFO] loss_pitch: {loss_pitch}')
        # print(f'[INFO] loss_roll: {loss_roll}')
    ...
    def get_target(self, target, anchors, in_w, in_h, ignore_threshold):
        ...
        tcls = torch.zeros(bs, int(self.num_anchors/3),
                            in_h, in_w, self.num_classes, requires_grad=False)
